...
contract FactoryOperatorableNew is Ownable2Step {
    ...
    modifier onlyOperator() {
        require(_roles[OPERATOR_ROLE][_msgSender()], "Operatorable: CALLER_NO_OPERATOR_ROLE");
        _;
    }

    modifier onlyAdmin() {
        require(_roles[ADMIN_ROLE][_msgSender()], "Operatorable: CALLER_NO_ADMIN_ROLE");
        _;
    }
