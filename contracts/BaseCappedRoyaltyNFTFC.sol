...
import "./lib/FactoryOperatorableNew.sol";
import "@openzeppelin/contracts/metatx/ERC2771Context.sol";
import "@openzeppelin/contracts/metatx/MinimalForwarder.sol";

contract BaseRoyaltyCappedNFTFC is ERC2771Context, ERC721Enumerable, ERC721URIStorage, IERC2981, FactoryOperatorableNew  {
    // Base token URI
    ...
    constructor(
        ...
        address admin,
        address operator
    ) ERC2771Context(_trustedForwarder) ERC721(_name, _symbol) FactoryOperatorableNew(admin, operator) {
    ...
    function supportsInterface(bytes4 _interfaceId) public view virtual override(ERC721, ERC721Enumerable, IERC165) returns (bool) {
    ...
    function _mint(address account, uint256 tokenId) internal virtual override {
        require(tokenId <= cap, "BaseRoyaltyCappedNFT#_mint: CANNOT_EXCEED_MINTING_CAP");
        super._mint(account, tokenId);
        emit Minted(tokenId, account);
    }
